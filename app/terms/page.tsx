      ...
      <main className="flex-1">
        ...
        <Section background="default" className="py-12">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Our Services</h2>
            ...
            <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Recruitment Services</h2>
            <p className="text-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">CV and Career Services</h2>
            <p className="text-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">User Responsibilities</h2>
            <p className="text-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Third-Party Links</h2>
            <p className="text-foreground leading-relaxed mb-6">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Professional Advice</h2>
            <p className="text-foreground leading-relaxed mb-6">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Confidentiality</h2>
            <p className="text-foreground leading-relaxed mb-6">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Service Modifications</h2>
            <p className="text-foreground leading-relaxed mb-6">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Termination</h2>
            <p className="text-foreground leading-relaxed mb-6">
