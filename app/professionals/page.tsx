        ...
        <Section background="light" className="pt-32 pb-20">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.05] mb-8">
              <span className="text-navy-deep">Ready for Your Next</span>
              <br />
              <span className="text-blue-royal">Career Opportunity?</span>
            </h1>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {services.map((service, index) => (
                <motion.div
                  ...
                  className="bg-white border border-neutral-200 rounded-lg p-6 hover:shadow-lg transition-all hover:-translate-y-1"
                >
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.6, delay: index * 0.1 }}
                  className="text-center bg-white p-6 rounded-lg border border-neutral-200"
                >
                  <div className="w-16 h-16 rounded-full bg-gold/20 flex items-center justify-center text-xl font-bold text-gold mx-auto mb-4">
                    {step.number}
                  </div>
