      ...
      <div className="container-premium">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            {/* Card Content */}
            <div className="relative bg-card p-8 lg:p-10 rounded-tl-3xl rounded-br-3xl border border-primary/20 group-hover:-translate-y-1 group-hover:-translate-x-1 transition-all duration-300">
                ...
                <div className="space-y-4">
                  {assessmentCriteria.map((criterion, index) => (
                    <motion.div
                      ...
                      className="flex items-center gap-4 p-4 bg-gradient-to-r from-primary/5 to-transparent rounded-tl-2xl rounded-br-2xl border border-primary/10 hover:border-primary/30 transition-colors duration-300"
                    >
                      ...
                      <span className="text-lg font-medium text-foreground">{criterion}</span>
                    </motion.div>
                  ))}
                </div>
              </div>
