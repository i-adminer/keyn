    ...
    <section className="relative py-20 overflow-hidden border-b">
      ...
      <div className="container-premium relative z-10">
        ...
        <div className="hidden lg:block relative">
          {/* Connection Line */}
          <div className="absolute top-[2.5rem] left-0 right-0 h-1 bg-border/30">
            <motion.div
              initial={{ scaleX: 0 }}
              whileInView={{ scaleX: 1 }}
              viewport={{ once: true }}
              transition={{ duration: 1.5, ease: "easeOut" }}
              className="h-full bg-gradient-to-r from-primary via-secondary to-primary origin-left rounded-full"
            />
          </div>
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="relative z-10 mb-6">
                  <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary to-secondary p-0.5 group-hover:scale-110 transition-transform duration-300">
